...
public class SpringRestClientServiceImpl implements SpringRestClientService {
    ...
    public UserDto getUserDto(HttpServletRequest request) {
        ...
        ResponseEntity<UserDto> response = restTemplate.exchange(systemConfiguration.getServiceUrl("CORE") + "userdto/mobile/" + currentUser,
    ...
    public UserDto getUserDtoForOtherUser(HttpServletRequest request, String mobileNumber) {
        ...
        try {
            response = restTemplate.exchange(systemConfiguration.getServiceUrl("CORE") + "userdto/mobile/" + mobileNumber, HttpMethod.GET, req,
                    UserDto.class);
            UserDto userDto = response.getBody();
            return userDto;
...
//        	 ResponseEntity<List<MyBean>> response = template.exchange("http://example.com",HttpMethod.GET, null, myBean);
    ...
    public UserDto getUserDtoForOtherUserById(HttpServletRequest request, Integer userId) {
        ...
        String authCredentials = request.getHeader("Authorization");
        HttpEntity<String> req = new HttpEntity<String>(getHeaders(principal, authCredentials));
        ResponseEntity<UserDto> response = restTemplate.exchange(systemConfiguration.getServiceUrl("CORE") + "profile/" + userId,
                HttpMethod.GET, req, UserDto.class);
        UserDto userDto = response.getBody();
        return userDto;
    }
    ...
    public UserDto getUserDtoUsingDefaultHeaders(String mobileNumber) {
        ...
        ResponseEntity<UserDto> response = restTemplate.exchange(systemConfiguration.getServiceUrl("CORE") + "userdto/mobile/" + mobileNumber,
                HttpMethod.GET, req, UserDto.class);
        UserDto userDto = response.getBody();
        return userDto;
    }
    ...
    public Map<Object, Object> getUserMap(HttpServletRequest request) {
        ...
        ResponseEntity<Map<Object, Object>> response = restTemplate.exchange(systemConfiguration.getServiceUrl("CORE") + "userdto/mobile/" + currentUser,
    ...
    public String postCampaignDataUsingDefaultHeaders(Integer complaintId, String rating) {
        ...
        ResponseEntity<String> response = restTemplate.exchange(systemConfiguration.getServiceUrl("CORE") + "resolvedComplaintFeedback/",
    ...
    public Object createComplaintForMissingItems(LuggageTransactionStatusDto luggageTransactionStatusDto,
        ...
        try {
            ...
            HttpEntity<HashMap<String, Object>> req = new HttpEntity<HashMap<String, Object>>(map,
                    getDefaultHeadersForPost());
            response = restTemplate.exchange(systemConfiguration.getServiceUrl("COMPLAINT") + "complaint/", HttpMethod.POST, req,
                    String.class);
